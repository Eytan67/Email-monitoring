...
from explosive_comsumer.models import create_email_obj, \
    create_location_obj, create_device_info_obj, create_suspicious_hostage_content_obj
...
consumer = KafkaConsumer(
    ...
    group_id='hostage_messages_group',
...
for email in consumer:
    ...
    try:
        ...
        suspicious_content_obj = create_suspicious_hostage_content_obj(sentences_data, email_id)
